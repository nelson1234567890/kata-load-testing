...
public class flujoReusoCheckOutCorregido extends Simulation {
  ...
  private Map<CharSequence, String> headers4 = Map.ofEntries(
    ...
    Map.entry("x-strcode", "4cc8dcd3053fcc058a07dc7089b0478e")
  );
  ...
  private Map<CharSequence, String> headers15 = Map.ofEntries(
    ...
    Map.entry(valSecMode, "same-origin"),
    Map.entry(valSecSite, "same-origin"),
    Map.entry(valUserAgent, valMozilla),
    Map.entry("x-client-data", "CKG1yQEIlbbJAQimtskBCMK2yQEIqZ3KAQialcsBCJShywEIhqDNAQi9os0B")
  );
  ...
  private Map<CharSequence, String> headers19 = Map.ofEntries(
    ...
    Map.entry(valSecSite, valCrossSite),
    Map.entry(valUserAgent, valMozilla),
    Map.entry(valToken, "5ee4b344-b18d-4436-b76b-a16e048983a8"),
  ...
  private Map<CharSequence, String> headers37 = Map.ofEntries(
    ...
    Map.entry(valSecMode, "navigate"),
    Map.entry(valSecSite, "same-site"),
    Map.entry("upgrade-insecure-requests", "1"),
    Map.entry(valUserAgent, valMozilla)
  );
  ...
  private Map<CharSequence, String> headers38 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valContetType, "application/json; charset=utf-8"),
    Map.entry(valOrigin, "https://authenticatormock.labdigitalbdbstaging.co"),
    Map.entry(valSec, valChromium),
    Map.entry(valSecMobile, "?0"),
    Map.entry(valSecPlataform, valMacOs),
    Map.entry(valSecDest, valEmpty),
  ...
  private Map<CharSequence, String> headers40 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valContetType, "application/json"),
    Map.entry(valOrigin, "https://authenticatormock.labdigitalbdbstaging.co"),
    Map.entry(valSec, valChromium),
    Map.entry(valSecMobile, "?0"),
    Map.entry(valSecPlataform, valMacOs),
  ...
  private Map<CharSequence, String> headers41 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valAccess, "aditional-info,channel,content-type,product"),
    Map.entry(valAccessControl, "POST"),
    Map.entry(valOrigin, "https://authenticatormock.labdigitalbdbstaging.co"),
    Map.entry(valSecDest, valEmpty),
    Map.entry(valSecMode, "cors"),
  ...
  private Map<CharSequence, String> headers48 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valOrigin, "https://bnpl.labdigbdbstgae.com"),
    Map.entry(valSec, valChromium),
    Map.entry(valSecMobile, "?0"),
    Map.entry(valSecPlataform, valMacOs),
    Map.entry(valSecDest, "script"),
  ...
  private Map<CharSequence, String> headers57 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valContetType, "text/plain"),
    Map.entry(valOrigin, "https://bnpl.labdigbdbstgae.com"),
    Map.entry(valSec, valChromium),
    Map.entry(valSecMobile, "?0"),
    Map.entry(valSecPlataform, valMacOs),
  ...
  private Map<CharSequence, String> headers70 = Map.ofEntries(
    ...
    Map.entry(valueAcceptEncoding, valueAcceptParamats),
    Map.entry(valAcceptLanguage, valES),
    Map.entry(valAccess, "x-accesstoken,x-auth-token,x-channel,x-companyid,x-custidentnum,x-custidenttype,x-ipaddr,x-journey,x-name,x-rquid,x-strcode"),
    Map.entry(valAccessControl, "POST"),
    Map.entry(valOrigin, "https://bnpl.labdigbdbstgae.com"),
    Map.entry(valSecDest, valEmpty),
    Map.entry(valSecMode, "cors"),
